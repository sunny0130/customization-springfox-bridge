package com.github.sunny0130.customization.springfox.bridge.core;

import com.github.sunny0130.customization.springfox.bridge.core.builder.BridgeControllerBuilder;
...
import com.github.sunny0130.customization.springfox.bridge.core.util.FileUtil;
...
import com.github.sunny0130.customization.springfox.bridge.core.util.ReflectUtil;
import com.github.sunny0130.customization.springfox.bridge.core.util.StringUtil;
...
public class SpringfoxBridge {
    ...
    public static void start(ApplicationContext context) {
        try {
            ...
            log.info("Start customization-springfox-bridge success.");
        } catch (Exception e) {
            log.error("Start customization-springfox-bridge failed.", e);
        }
    }
    ...
    private static ApiInfo apiInfo(String group, Set<String> authors) {
        String author = "customization-springfox-bridge";

package io.springfox.bridge.core;

import io.springfox.bridge.core.builder.BridgeControllerBuilder;
...
import io.springfox.bridge.core.util.FileUtil;
...
import io.springfox.bridge.core.util.StringUtil;
...
public class SpringfoxBridge {
    ...
    private static void registerGroupDocket(String group) {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2).groupName(group)
